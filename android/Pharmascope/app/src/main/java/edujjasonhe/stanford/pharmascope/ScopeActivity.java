...
public class ScopeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //sendLoc = intent.getStringExtra("devNum");
    ...
    private void getResultsFromApi() {
        if (! isGooglePlayServicesAvailable()) {
            ...
            new ScopeActivity.MakeRequestTask(mCredential).execute();
        }
    }
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        private List<String> getDataFromApi() throws IOException {
            ...
            String rangeHistory = "history!A"+Integer.toString(historyRow)+":E";
            ...
            String rangeOrder = "order_info!H"+Integer.toString(orderRow)+":I";
